                                   ...
                                   <b-card
                                        ...
                                        <b-card-body style="margin-top:-20px;">
                                            ...
                                            <div class="row" style="margin-top:-25px;">
                                                <div class="col-md-12">
                                                  <span v-if="getRatings(event_item.created_by)!=0"><a-rate v-bind:value="getRatings(event_item.created_by)" allowHalf />
                                                    ({{getRatings(event_item.created_by).toString().substring(0, 3)}})
...
<script>
  ...
  export default {
    ...
    computed : {
        ...mapGetters(['users','events','ratings']),
        getSelectedEvents() {
