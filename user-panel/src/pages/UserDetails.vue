      ...
      <div class="section section-images">
        <div class="container" id="top">
          <div class="col-md-12">
            ...
            <div class="row">
                <div class="col-md-8"> 
                    <h3 class="text-info"><b>Events Hosted</b></h3>
                    <div class="row">
                        <div class="col-md-6" v-for="(event, index) in getEvents" :key="index">
                            <div class="card" style="cursor: pointer" v-if="event.created_by == userId">
                    ...
                    <div class="card card-plain">
                        <div class="card-header">
                            ...
                            <div class="text-center mt-3">
                                <h6 class="text-success title-up ml-3 pull-left">Events Hosted: <b> {{ Object.keys(this.user.events_hosted).length }} </b></h6>
                                <h6 class="text-success title-up ml-3">Events Attended: <b> {{ Object.keys(this.user.events_attended).length }} </b></h6>
                            </div>
                            <hr class="mt-5">
                            <div class="about">
